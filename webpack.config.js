...
module.exports = {
    entry: {
        'syagr-admin': getEntrySources(ngAdminAndVendorSources),
        'syagr-admin-only': getEntrySources(ngAdminSources)
    },
    output: {
    ...
    module: {
        loaders: [
            ...
            { test: /\.js/, loaders: ['babel'], exclude: /node_modules\/(?!ng-admin)/ },
